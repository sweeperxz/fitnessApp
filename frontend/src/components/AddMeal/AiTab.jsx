...
Описание приёма пищи: ${q}`
    ...
    const statColors = { 'Ккал': 'var(--blue2)', 'Белки': 'var(--purple)', 'Жиры': 'var(--amber)', 'Углев': 'var(--blue)' }

    return (
        <>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
                <div style={{ flex: 1, height: 1, background: 'var(--border)' }} />
                <span style={{ fontSize: 11, color: 'var(--text3)', whiteSpace: 'nowrap' }}>Опиши порцию и мы посчитаем КБЖУ</span>
                <div style={{ flex: 1, height: 1, background: 'var(--border)' }} />
            </div>
            ...
            <textarea
                className="input"
                placeholder="Например: тарелка гречки 200г с куриной грудкой 150г и оливковым маслом 1 ч.л."
                value={text}
            ...
            {result && (
                <div style={{
                    ...
                    <div style={{ display: 'flex', gap: 6, marginBottom: 14 }}>
                        {[
                            { l: 'Ккал', v: result.calories },
                            { l: 'Белки', v: result.protein + 'г' },
                            { l: 'Жиры', v: result.fat + 'г' },
                            { l: 'Углев', v: result.carbs + 'г' },
                        ].map(s => (
                            <div key={s.l} style={{
